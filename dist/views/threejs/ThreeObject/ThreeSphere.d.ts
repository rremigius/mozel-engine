...
export default class ThreeSphere extends ThreeObject {
    static Model: typeof SphereModel;
    model: SphereModel;
    get mesh(): Mesh<import("three").BufferGeometry, import("three").Material | import("three").Material[]>;
    onInit(): void;
    createGeometry(): SphereGeometry;
    updateGeometry: import("lodash").DebouncedFunc<() => void>;
    createObject3D(): {
